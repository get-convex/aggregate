 ...
 * obvious. Queued first, matching the scoreboard and comparison charts.
 *
...
export function LatencySection({
  ...
  const order = [cells.queued, cells.eager].filter((c) => c.jobCount > 0);
            ...
            <Group gap={6}>
              <div
                style={{
                  ...
                  height: 8,
                  borderRadius: 2,
                  background: MODE_COLOR[cell.mode],
                }}
              />
              <Text size="sm" c="white">
                {cell.mode === "async" ? "Queued" : "Eager"}
              </Text>
